...
if (!checkout || !fs.existsSync(path.join(checkout, 'packages/benchmark'))) {
  throw new Error('usage: node scripts/build-vue-m3.mjs <vue-lynx-checkout>');
}
...
const configurations = [
  { id: 'reactlynx-m3-default', app: 'ui-react' },
  { id: 'reactlynx-m3-et', app: 'ui-react', elementTemplates: true },
  { id: 'vue-lynx-m3-vdom-default', app: 'ui-vdom' },
  {
  ...
  { id: 'vue-lynx-m3-vapor-default', app: 'ui-vapor', cell: 'off' },
  { id: 'vue-lynx-m3-vapor-ifr', app: 'ui-vapor', ifr: true, cell: 'ifr' },
];
...
console.log(`[build-vue-m3] ${configurations.length * rowsMatrix.length} cells → ${out}`);
