...
test('a stricter accepted-sample policy publishes only after its threshold is met', () => {
...
test('unknown reportability, capacity, fixture, outcome, and failure contracts fail closed', () => {
  for (const [changed, pattern] of [
    [{ reportability: { protocol: 'future-v2', minAcceptedSamples: 5 } }, /reportability protocol/],
